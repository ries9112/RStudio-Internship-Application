...
The bookdown example from earlier https://predictcryptodb-quickstart.com/ for example uses those tools to refresh the guide daily in order to show the latest data in the *useful tables* section:

```{r, echo=F}
knitr::include_url("https://predictcryptodb-quickstart.com/useful-tables.html")
```
