...
This guide refreshes daily in order to show a preview of the latest data within the document [and you can look at the GitHub Actions daily runs here](https://github.com/ries9112/PredictCryptoDB/actions)

How does URL itself look here (DELETE THIS:)
```{r echo=F, fig.width=900}
knitr::include_url("https://github.com/ries9112/PredictCryptoDB/actions")
```
