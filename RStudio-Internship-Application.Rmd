...
I post these on my website: https://predictcrypto.org/tutorials
...
Pagedown[@R-pagedown] is yet another awesome way to create html outputs. I used Nick Strayer's repository: https://github.com/nstrayer/cv to build my cv and resume using his template:
