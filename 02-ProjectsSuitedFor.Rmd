...
Another good resource to look at: https://towardsdatascience.com/modelling-with-tidymodels-and-parsnip-bae2c01c131c



Yardstick for metrics: https://tidymodels.github.io/yardstick/

```{r}
library(yardstick)
metrics(xgboost_predictions, target_percent_change,  estimate = .pred)
```
