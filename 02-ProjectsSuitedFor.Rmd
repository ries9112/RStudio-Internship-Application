...
# googlesheets_data <- read_sheet(spreadsheet_url, sheet = 'coinmetrics_preview') %>% as.data.frame() # won't work on Github Actions
googlesheets_data <- read.csv('unioned_data_upload.csv', stringsAsFactors = F)
```
