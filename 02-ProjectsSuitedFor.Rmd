...
```{r remove_fields}
exercise_data <- select(exercise_data, -date_time_utc, -date_time, -pkDummy, -pkey, -price_usd_x_daysLater, -date_time_x_daysLater, -cap_real_usd, -cap_mvrv_cur)
```
...
1. How much better do the models get if we add more variables? Adding timeseries components like Moving Averages.
