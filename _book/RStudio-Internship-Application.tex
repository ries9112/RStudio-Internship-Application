...
\section{1. Create resources for people working with spreadsheets in R}\label{create-resources-for-people-working-with-spreadsheets-in-r}}
...
\section{2. Build interactive learnr tutorials for tidymodels}\label{build-interactive-learnr-tutorials-for-tidymodels}}
...
\section{3. Build interactive learnr tutorials for Python using reticulate}\label{build-interactive-learnr-tutorials-for-python-using-reticulate}}

knitr::include\_app(``\url{https://predictcrypto.shinyapps.io/R_Basics/}'',
height = ``600px'')
