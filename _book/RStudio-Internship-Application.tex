...
\begin{verbatim}
## Read googlesheets data: 36.58 sec elapsed
\end{verbatim}
...
\begin{verbatim}
## Feature scaling: 0.19 sec elapsed
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{xgboost_model <-}\StringTok{ }\NormalTok{xgboost_parsnip <-}\StringTok{ }\KeywordTok{boost_tree}\NormalTok{() }\OperatorTok{%>%}
...
Now we can go ahead and fit the models to the data:
...
\begin{verbatim}
## Random Forest: 14.57 sec elapsed
\end{verbatim}
...
\begin{verbatim}
## Predictive Modeling: 16.22 sec elapsed
\end{verbatim}
...
\begin{verbatim}
## Total section 3 runtime: 64.88 sec elapsed
\end{verbatim}
