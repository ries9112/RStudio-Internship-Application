...
\NormalTok{lm_fitted <-}\StringTok{ }\NormalTok{lm_model }\OperatorTok{%>%}\StringTok{ }\KeywordTok{fit}\NormalTok{(target_percent_change }\OperatorTok{~}\StringTok{ }\NormalTok{., }\DataTypeTok{data=}\NormalTok{crypto_train) }\CommentTok{# fit price_usd to all variables except for the symbol}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-21-1.pdf}

\begin{verbatim}
## [1] "Now showing BTC variable importance:"
\end{verbatim}

\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-21-2.pdf}

\begin{verbatim}
## [1] "Now showing LTC variable importance:"
\end{verbatim}

\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-21-3.pdf}

\begin{verbatim}
## [1] "Now showing DASH variable importance:"
\end{verbatim}

\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-21-4.pdf}

\begin{verbatim}
## [1] "Now showing BCH variable importance:"
\end{verbatim}

\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-21-5.pdf}
...
\href{https://ricky-cv.netlify.com/}{\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-23-1.pdf}}
