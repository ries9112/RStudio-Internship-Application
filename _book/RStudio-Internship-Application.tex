...
\begin{verbatim}
## Read googlesheets data: 38.62 sec elapsed
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{random_forest_model <-}\StringTok{ }\KeywordTok{rand_forest}\NormalTok{(}\DataTypeTok{trees =} \DecValTok{1000}\NormalTok{, }\DataTypeTok{mode =} \StringTok{"regression"}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{xgboost_model <-}\StringTok{ }\NormalTok{xgboost_parsnip <-}\StringTok{ }\KeywordTok{boost_tree}\NormalTok{(}\DataTypeTok{trees=}\DecValTok{1000}\NormalTok{, }\DataTypeTok{tree_depth =} \DecValTok{8}\NormalTok{) }\OperatorTok{%>%}
...
\begin{verbatim}
## Random Forest: 142.03 sec elapsed
\end{verbatim}
...
\begin{verbatim}
## Predictive Modeling: 168.71 sec elapsed
\end{verbatim}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include_app}\NormalTok{(}\StringTok{"https://predictcrypto.shinyapps.io/python_project3_example/"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
## Total section 3 runtime: 221.07 sec elapsed
\end{verbatim}
...
\href{https://ricky-cv.netlify.com/}{\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-22-1.pdf}}
