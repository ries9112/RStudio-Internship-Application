...
\href{https://predictcrypto.shinyapps.io/R_Basics/}{\includegraphics{RStudio-Internship-Application_files/figure-latex/show_r_basics_tutorial-1.pdf}}
...
\href{https://predictcrypto.com/tutorials}{\includegraphics{RStudio-Internship-Application_files/figure-latex/show_website-1.pdf}}
...
\href{https://predictcryptodb-quickstart.com/}{\includegraphics{RStudio-Internship-Application_files/figure-latex/show_bookdown-1.pdf}}
...
\href{https://predictcryptoblog.com/}{\includegraphics{RStudio-Internship-Application_files/figure-latex/show_blog-1.pdf}}
...
\href{https://ricky-cv.netlify.com/resume}{\includegraphics{RStudio-Internship-Application_files/figure-latex/show_resume-1.pdf}}
...
\href{https://predictcrypto.shinyapps.io/SemanticAnalysisExample/}{\includegraphics{RStudio-Internship-Application_files/figure-latex/show_flexdashboard-1.pdf}}
...
\href{https://docs.google.com/spreadsheets/d/1_zRBFrB1au7qhxuDDfDuh_bPLGd6RLrwOL5oQ3sBBX4/edit\#gid=395468559}{\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-2-1.pdf}}
...
\NormalTok{googlesheets_data <-}\StringTok{ }\KeywordTok{read_sheet}\NormalTok{(spreadsheet_url, }\DataTypeTok{sheet =} \StringTok{'coinmetrics_preview'}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{() }\CommentTok{# won't work with Github Actions}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(exercise_data}\OperatorTok{$}\NormalTok{roi30d, }\DataTypeTok{na.rm=}\NormalTok{T)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(exercise_data}\OperatorTok{$}\NormalTok{cap_mrkt_cur_usd)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(crypto_data_scaled}\OperatorTok{$}\NormalTok{cap_mrkt_cur_usd,}\DecValTok{5}\NormalTok{)  }
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(exercise_data}\OperatorTok{$}\NormalTok{cap_mrkt_cur_usd,}\DecValTok{5}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{lm_model <-}\StringTok{ }\KeywordTok{linear_reg}\NormalTok{() }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{random_forest_model <-}\StringTok{ }\KeywordTok{rand_forest}\NormalTok{(}\DataTypeTok{trees =} \DecValTok{1000}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{set_engine}\NormalTok{(}\StringTok{"randomForest"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{set_mode}\NormalTok{(}\StringTok{"regression"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{xgboost_model <-}\StringTok{ }\NormalTok{xgboost_parsnip <-}\StringTok{ }\KeywordTok{boost_tree}\NormalTok{(}\DataTypeTok{trees=}\DecValTok{1000}\NormalTok{) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{exercise_data <-}\StringTok{ }\NormalTok{exercise_data }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{date_time_utc, }\OperatorTok{-}\NormalTok{date_time, }\OperatorTok{-}\NormalTok{pkDummy, }\OperatorTok{-}\NormalTok{pkey, }\OperatorTok{-}\NormalTok{cap_real_usd, }\OperatorTok{-}\NormalTok{cap_mvrv_cur)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{nrow}\NormalTok{(crypto_train) }\CommentTok{# 80% of rows}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{nrow}\NormalTok{(crypto_test) }\CommentTok{# 20% of rows}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{lm_fitted <-}\StringTok{ }\NormalTok{lm_model }\OperatorTok{%>%}\StringTok{ }\KeywordTok{fit}\NormalTok{(target_percent_change }\OperatorTok{~}\StringTok{ }\NormalTok{., }\DataTypeTok{data=}\NormalTok{crypto_train)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{fit}\NormalTok{(target_percent_change }\OperatorTok{~}\StringTok{ }\NormalTok{., }\DataTypeTok{data =}\NormalTok{ crypto_train)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-12-1.pdf}

\hypertarget{add-metrics}{%
\subsection{Add Metrics}\label{add-metrics}}

Now we can use \texttt{broom} \citep{R-broom} to get all sorts of metrics back on the models:
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(vip)}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(crypto_models_metrics}\OperatorTok{$}\NormalTok{symbol))\{}
  \KeywordTok{print}\NormalTok{(}\KeywordTok{paste}\NormalTok{(}\StringTok{"Now showing"}\NormalTok{, crypto_models_metrics}\OperatorTok{$}\NormalTok{symbol[[i]], }\StringTok{"variable importance:"}\NormalTok{))}
  \KeywordTok{print}\NormalTok{(}\KeywordTok{vip}\NormalTok{(crypto_models_metrics}\OperatorTok{$}\NormalTok{model[[i]]))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RStudio-Internship-Application_files/figure-latex/vip_plots_loop-1.pdf}

\begin{verbatim}
## [1] "Now showing BTC variable importance:"
\end{verbatim}

\includegraphics{RStudio-Internship-Application_files/figure-latex/vip_plots_loop-2.pdf}

\begin{verbatim}
## [1] "Now showing LTC variable importance:"
\end{verbatim}

\includegraphics{RStudio-Internship-Application_files/figure-latex/vip_plots_loop-3.pdf}

\begin{verbatim}
## [1] "Now showing DASH variable importance:"
\end{verbatim}

\includegraphics{RStudio-Internship-Application_files/figure-latex/vip_plots_loop-4.pdf}

\begin{verbatim}
## [1] "Now showing BCH variable importance:"
\end{verbatim}

\includegraphics{RStudio-Internship-Application_files/figure-latex/vip_plots_loop-5.pdf}
...
\href{https://predictcrypto.shinyapps.io/python_project3_example/}{\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-13-1.pdf}}
...
\href{https://ricky-cv.netlify.com/}{\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-14-1.pdf}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{subset}\NormalTok{(cryptoData, Name }\OperatorTok{==}\StringTok{ 'Bitcoin'}\NormalTok{), }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ DateTimeUTC, }\DataTypeTok{y =}\NormalTok{ PriceUSD)) }\OperatorTok{+}
\StringTok{  }
\StringTok{  }\KeywordTok{geom_jitter}\NormalTok{(}\DataTypeTok{alpha=}\FloatTok{0.75}\NormalTok{, }\DataTypeTok{colour=}\StringTok{'deepskyblue4'}\NormalTok{) }\OperatorTok{+}
\StringTok{  }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title=}\KeywordTok{paste}\NormalTok{(}\StringTok{'Bitcoin'}\NormalTok{, }\StringTok{' - Price USD'}\NormalTok{),}
       \DataTypeTok{x=}\StringTok{'DateTime MST (Colorado Time)'}\NormalTok{, }\DataTypeTok{y=}\StringTok{'% Change Vs. USD ($)'}\NormalTok{) }\OperatorTok{+}
\StringTok{  }
\StringTok{  }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{colour=}\StringTok{'coral3'}\NormalTok{)  }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_economist}\NormalTok{()}

\KeywordTok{ggplotly}\NormalTok{(plot)}
\end{Highlighting}
\end{Shaded}

\includegraphics{RStudio-Internship-Application_files/figure-latex/price_usd_btc_7d-1.pdf}
...
\includegraphics{RStudio-Internship-Application_files/figure-latex/plotPickVariable-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{filter}\NormalTok{(targetData, Rank }\OperatorTok{>=}\StringTok{ }\DecValTok{1}\NormalTok{, Rank }\OperatorTok{<=}\StringTok{ }\DecValTok{5}\NormalTok{ ), }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ DateTimeUTC, }\DataTypeTok{y =}\NormalTok{ TargetPercChange, }\DataTypeTok{colour=}\NormalTok{Name)) }\OperatorTok{+}
\StringTok{  }
\StringTok{  }\KeywordTok{geom_jitter}\NormalTok{(}\DataTypeTok{alpha=}\FloatTok{0.75}\NormalTok{) }\OperatorTok{+}
\StringTok{  }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x=}\StringTok{'DateTime MST (Colorado Time)'}\NormalTok{, }\DataTypeTok{y=}\StringTok{'6h % Change Vs. USD ($)'}\NormalTok{) }\OperatorTok{+}
\StringTok{  }
\StringTok{  }\KeywordTok{geom_smooth}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{group=}\NormalTok{Name), }\DataTypeTok{se=}\NormalTok{F)  }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_solarized}\NormalTok{(}\DataTypeTok{light=}\NormalTok{F)}

\KeywordTok{ggplotly}\NormalTok{(plot)}
\end{Highlighting}
\end{Shaded}

\includegraphics{RStudio-Internship-Application_files/figure-latex/6h_change_7d_top5-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{subset}\NormalTok{(targetData24, Name }\OperatorTok{==}\StringTok{ 'Bitcoin'}\NormalTok{), }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ PercChange24hVsUSD, }\DataTypeTok{y =}\NormalTok{ TargetPercChange)) }\OperatorTok{+}
\StringTok{  }
\StringTok{  }\KeywordTok{geom_jitter}\NormalTok{(}\DataTypeTok{alpha=}\FloatTok{0.75}\NormalTok{, }\DataTypeTok{colour=}\StringTok{'deepskyblue4'}\NormalTok{) }\OperatorTok{+}
\StringTok{  }
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title=}\StringTok{'Bitcoin'}\NormalTok{,}
       \DataTypeTok{x=}\StringTok{'% Change Previous 24h vs. $'}\NormalTok{, }\DataTypeTok{y=}\StringTok{'% Change Next 24h vs. $'}\NormalTok{) }\OperatorTok{+}
\StringTok{  }
\StringTok{  }\KeywordTok{geom_smooth}\NormalTok{(}\DataTypeTok{colour=}\StringTok{'coral3'}\NormalTok{,}\DataTypeTok{se=}\NormalTok{F)  }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_wsj}\NormalTok{()}

\KeywordTok{ggplotly}\NormalTok{(plot)}
\end{Highlighting}
\end{Shaded}

\includegraphics{RStudio-Internship-Application_files/figure-latex/prev_to_target_24h-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# output$pricePlotStats <- renderPlot(\{}
\CommentTok{#   ggscatterstats(data = filter(targetData24, Name == input$cryptocurrencyNameRel), x = PercChange24hVsUSD, y = TargetPercChange, messages=F)}
\CommentTok{# \})}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{RStudio-Internship-Application_files/figure-latex/12h_change_7d_top100-1.pdf}
...
\includegraphics{RStudio-Internship-Application_files/figure-latex/24h_change_by_date-1.pdf}
...
\includegraphics{RStudio-Internship-Application_files/figure-latex/rows_collected_by_algo-1.pdf}
