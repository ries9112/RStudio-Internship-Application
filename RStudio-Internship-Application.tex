...
\href{https://predictcrypto.shinyapps.io/SemanticAnalysisExample/}{\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-5-1.pdf}}
...
\href{https://docs.google.com/spreadsheets/d/1_zRBFrB1au7qhxuDDfDuh_bPLGd6RLrwOL5oQ3sBBX4/edit\#gid=395468559}{\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-6-1.pdf}}
...
\begin{verbatim}
## Read googlesheets data: 36.36 sec elapsed
\end{verbatim}
...
\begin{verbatim}
## Random Forest: 142.64 sec elapsed
\end{verbatim}
...
\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-19-1.pdf}
...
\begin{verbatim}
## Predictive Modeling: 163.46 sec elapsed
\end{verbatim}
...
\href{https://predictcrypto.shinyapps.io/python_project3_example/}{\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-20-1.pdf}}
...
\begin{verbatim}
## Total section 3 runtime: 213.42 sec elapsed
\end{verbatim}
...
\href{https://ricky-cv.netlify.com/}{\includegraphics{RStudio-Internship-Application_files/figure-latex/unnamed-chunk-21-1.pdf}}
...
For rayshader separate camera settings and just write a line explaining it's just camera settings. So first make normal chart, then import rayshader, set filename\_movie name and all camera settings
